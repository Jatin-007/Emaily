...
import { BrowserRouter, Route } from 'react-router-dom'; //BrowserRouter: how to behave at certain levels, Route: used to setup rule to the linke the user might visit
